 ...
 */
package spp2.lsosab.a08;

/**
 *
 * @author Alumno
 */
public class SPP2LSosaBA08 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("El promedio de los numeros pares es igual a = " + promedio);
        ...
        System.out.println("La suma de las posiciones nones del areglo es igual a = " + sumaNon);
